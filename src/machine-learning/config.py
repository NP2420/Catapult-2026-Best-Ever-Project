...
GAUTSCHI_USER = os.getenv("G_USER")
BASE_DIR = Path(os.getenv("BASEPATH"))

DAISEE_ROOT = BASE_DIR / "DAiSEE"
CROPS_ROOT = BASE_DIR / "DAiSEE_crops"
CKPT_DIR = BASE_DIR / "clippy_checkpoints"
LOGS_DIR = BASE_DIR / "clippy_logs"
ONNX_PATH = BASE_DIR / "onxx" / "clippy_engagement.onnx"
ONNX_INT8 = BASE_DIR / "onxx" / "clippy_engagement_int8.onnx"

# DAiSEE internal structure
DAISEE_LABELS = {
